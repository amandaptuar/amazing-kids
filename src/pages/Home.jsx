...
const Home = () => {
  useSEO({
    title: 'Home',
    description: "Welcome to Amazing Kids of India, India's First Ranking Competition.",
    keywords: "amazing kids, ranking competition, youth sports, india kids",
    url: "https://amazingkidsofindia.com/",
    image: "https://amazingkidsofindia.com/assets/hero_athletics.png"
  });
            ...
            <div className="contact-info-cards-wrapper">
              ...
              <div className="contact-info-card">
                ...
                <div className="contact-info-content">
                  <p className="contact-info-title">Have Any Question?</p>
                  <p className="contact-info-text">+91 9527557335<br/>+91 9730757335</p>
                </div>
              </div>
              {/* Email */}
              <div className="contact-info-card">
                ...
                <div className="contact-info-content">
                  <p className="contact-info-title">Send Email</p>
                  <p className="contact-info-text">amazingkidsofindia@gmail.com</p>
                </div>
              </div>
              {/* Address */}
              <div className="contact-info-card">
                ...
                <div className="contact-info-content">
                  ...
                  <p className="contact-info-text address-text">Flat no. 9, Patil Park, Bldg no. 6,<br/>Nashik, Opp. Vasant Market,<br/>Maharashtra — 422101</p>
                </div>
              </div>
            </div>
