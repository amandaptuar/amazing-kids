...
const Certificate = () => {
  ...
  if (loading) return <div style={{ minHeight: '100vh', display: 'flex', justifyContent: 'center', alignItems: 'center' }}>Loading Certificate...</div>;
    ...
    <div style={{ backgroundColor: '#f1f5f9', minHeight: '100vh', paddingTop: '120px', paddingBottom: '40px', paddingLeft: '20px', paddingRight: '20px', fontFamily: 'var(--font-body)' }}>
      ...
      <div 
        ...
        style={{ 
          ...
          aspectRatio: '1.414 / 1', // A4 Landscape ratio roughly
          padding: '40px',
